...
CANDIDATES: List[Dict[str, Any]] = [
    ...
    {
        "name": "nocicim_soft_crash_guard",
        "frontend": "nocicim_risk_field",
        "overrides": {
            "front_distance_threshold_m": 5.5,
            "stop_distance_m": 1.8,
            "lateral_distance_threshold_m": 2.5,
            "slow_front_risk_threshold": 0.82,
            "stop_front_risk_threshold": 0.99,
            "slow_throttle_cap": 0.92,
            "lateral_steer_threshold": 0.90,
            "lateral_throttle_threshold": 0.92,
            "lateral_throttle_cap": 0.72,
            "lateral_steering_cap": 1.00,
            "front_decay": 0.58,
            "front_gain": 0.03,
            "front_slow_threshold": 0.94,
            "front_slow_throttle_cap": 0.94,
            "lateral_decay": 0.58,
            "lateral_gain": 0.03,
            ...
            "min_lateral_risk_for_guard": 0.25,
        },
    },
    {
        "name": "nocicim_crash_aware_route",
        "frontend": "nocicim_risk_field",
        "overrides": {
            "front_distance_threshold_m": 6.0,
            "stop_distance_m": 2.0,
            "lateral_distance_threshold_m": 3.0,
            "slow_front_risk_threshold": 0.88,
            "stop_front_risk_threshold": 0.99,
            "slow_throttle_cap": 0.92,
            "lateral_steer_threshold": 0.90,
            "lateral_throttle_threshold": 0.94,
            "lateral_throttle_cap": 0.80,
            "lateral_steering_cap": 1.00,
            "front_decay": 0.62,
            "front_gain": 0.035,
            "front_slow_threshold": 0.94,
    ...
    {
        "name": "nocicim_conservative_clean",
        "frontend": "nocicim_risk_field",
        "overrides": {
            "front_distance_threshold_m": 6.0,
            "stop_distance_m": 1.8,
            "lateral_distance_threshold_m": 2.0,
            "slow_front_risk_threshold": 0.97,
            "stop_front_risk_threshold": 0.99,
            "slow_throttle_cap": 0.96,
            "lateral_steer_threshold": 0.97,
            "lateral_throttle_threshold": 0.97,
            "lateral_throttle_cap": 0.90,
            "lateral_steering_cap": 1.00,
            "front_decay": 0.52,
            "front_gain": 0.02,
            "front_slow_threshold": 0.99,
            "front_slow_throttle_cap": 0.96,
            "lateral_decay": 0.52,
            "lateral_gain": 0.02,
            "lateral_guard_threshold": 0.99,
            "allow_direct_stop": False,
            "require_memory_for_stop": False,
            "min_front_risk_for_stop": 0.98,
            "require_risk_for_lateral_guard": True,
            "min_lateral_risk_for_guard": 0.30,
        },
    },
    {
        "name": "nocicim_monitor_only",
        "frontend": "nocicim_risk_field",
        "overrides": {
            "front_distance_threshold_m": 6.0,
            "stop_distance_m": 1.0,
            ...
            "slow_throttle_cap": 1.0,
            "lateral_steer_threshold": 1.01,
            "lateral_throttle_threshold": 1.01,
            "lateral_throttle_cap": 1.0,
            "lateral_steering_cap": 1.0,
            "front_decay": 0.0,
            "front_gain": 0.0,
            "front_slow_threshold": 1.01,
            "front_slow_throttle_cap": 1.0,
            "lateral_decay": 0.0,
            "lateral_gain": 0.0,
            "lateral_guard_threshold": 1.01,
            "allow_direct_stop": False,
            "require_memory_for_stop": False,
            "min_front_risk_for_stop": 1.01,
            "require_risk_for_lateral_guard": True,
